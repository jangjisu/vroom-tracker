...
class BrandingConfigurationTest {
    ...
    @Test
    @DisplayName("프로젝트 문서는 rest-route 명칭을 사용하고 내부 패키지명은 유지한다")
    void projectDocs_useRestRouteBrandingWhileKeepingInternalPackageName() throws Exception {
        ...
        assertThat(buildGradle).contains("group = 'com.vroomtracker'");
    }
}
